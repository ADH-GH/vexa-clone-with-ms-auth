...
export VEXA_TEAMS_AUTHENTICATED="${VEXA_TEAMS_AUTHENTICATED:-}"
export VEXA_TEAMS_USERDATA_S3_PATH="${VEXA_TEAMS_USERDATA_S3_PATH:-sessions/teams/automation}"
export VEXA_WAITING_ROOM_TIMEOUT_MS="${VEXA_WAITING_ROOM_TIMEOUT_MS:-600000}"
export VEXA_EVERYONE_LEFT_TIMEOUT_MS="${VEXA_EVERYONE_LEFT_TIMEOUT_MS:-900000}"
